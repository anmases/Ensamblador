;Este programa convierte un entero a String usando una variable que se guarda en memoria
...
; MOV AX, [4]: "mira" en la dirección de memoria 4 y añade a AX lo que encuentre allí, el primer byte. Por lo tanto, si se pone el nombre de la variable [numero], "mirará" en la dirección absoluta de dicha variable, ya que numero solo es una etiqueta o alias que representa una dirección en memoria.
...
;ACTUALIZACIÓN: parece ser que en TASM [numero] y numero son equivalentes y ambos colocan el valor de la variable